# AXONE objectarium schema

> Generated typescript types for [axone-objectarium contract](https://github.com/axone-protocol/contracts/tree//contracts/axone-objectarium).
...
```bash
yarn add @axone/objectarium-schema
```

or
```bash
npm install --save @axone/objectarium-schema
```

Then import wanted type :

```typescript
import type { InstantiateMsg } from "@axone/objectarium-schema";
```
